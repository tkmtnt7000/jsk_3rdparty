...
from webscraping_ros.srv import GetFortuneResponse
...
# Mainly written by MiyabiTane about getting constellation node
# https://github.com/tkmtnt7000/jsk_robot/pull/1
...
if __name__ == '__main__':
    get_fortune_server = GetFortuneService()
    rospy.spin()
